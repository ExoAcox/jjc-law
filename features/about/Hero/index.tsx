    ...
    return <Responsive>
        <div className="flex gap-8 sm:gap-12 md:gap-16 justify-between flex-col md:flex-row">
            <h1 className="flex flex-col gap-1 text-5xl sm:text-6xl lg:text-8xl font-light max-w-[600px]">
                <motion.div {...fadeInLeft()} className="text-amber-500 font-normal">JJC LAW OFFICE</motion.div><br />
        ...
        <motion.div {...fadeInBottom()} className="w-full aspect-3/1 relative mt-10 md:mt-20">
